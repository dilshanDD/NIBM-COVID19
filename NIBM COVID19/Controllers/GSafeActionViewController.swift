//
//  GSafeActionViewController.swift
//  NIBM COVID19
//
...
class GSafeActionViewController: UIViewController {
    ...
    let bearImageView: UIImageView = {
        let imageView = UIImageView(image: #imageLiteral(resourceName: "7"))
    ...
    let descriptionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string: "Wash hands !", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)])
        
        attributedText.append(NSAttributedString(string: "\n\n\nWash your hands often with soap and water for at least 20 seconds.", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.gray]))
