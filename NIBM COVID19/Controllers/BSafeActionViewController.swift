//
//  BSafeActionViewController.swift
//  NIBM COVID19
//
...
class BSafeActionViewController: UIViewController {
    ...
    let descriptionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string: "Cover your cough!", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)])
        
        attributedText.append(NSAttributedString(string: "\n\n\nCover your cough or sneeze with a tissue, then throw the tissue in the trash and wash your hands.", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.gray]))
       ...
       private let nextButton: UIButton = {
           ...
           button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 14)
           button.setTitleColor(.SafemainPink, for: .normal)
           button.addTarget(self, action: #selector(CSafe), for: .touchUpInside)
           return button
       }()
    ...
    fileprivate func setupBottomControls() {
     ...
     //MARK: - Selectors
    @objc func CSafe() {
        let C = CSafeActionViewController()
