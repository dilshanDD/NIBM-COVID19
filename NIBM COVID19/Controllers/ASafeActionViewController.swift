//
//  ASafeActionViewController.swift
//  NIBM COVID19
//
...
class ASafeActionViewController: UIViewController {
...
let descriptionTextView: UITextView = {
    ...
    let attributedText = NSMutableAttributedString(string: "Keep social distance!", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)])
    
    attributedText.append(NSAttributedString(string: "\n\n\nStay at least 6 feet (about 2 arms’ length) from other people.", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.gray]))
   ...
   private let nextButton: UIButton = {
       ...
       button.addTarget(self, action: #selector(BSafe), for: .touchUpInside)
       return button
   }()
...
fileprivate func setupBottomControls() {
    ...
    @objc func BSafe() {
        let B = BSafeActionViewController()
...
extension UIColor {
    static var SafemainPink = UIColor(red: 232/255, green: 68/255, blue: 133/255, alpha: 1)
}
