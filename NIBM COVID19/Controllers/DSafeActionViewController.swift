//
//  DSafeActionViewController.swift
//  NIBM COVID19
//
...
class DSafeActionViewController: UIViewController {
    ...
    let descriptionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string: "No toaching!", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)])
        
        attributedText.append(NSAttributedString(string: "\n\n\nDo not touch your eyes, nose, and mouth.", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.gray]))
       ...
       private let nextButton: UIButton = {
           ...
           button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 14)
           button.setTitleColor(.SafemainPink, for: .normal)
           button.addTarget(self, action: #selector(ESafe), for: .touchUpInside)
           return button
       }()
    ...
    fileprivate func setupBottomControls() {
     ...
     //MARK: - Selectors
    @objc func ESafe() {
        let E = ESafeActionViewController()
