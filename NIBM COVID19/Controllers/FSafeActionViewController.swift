//
//  FSafeActionViewController.swift
//  NIBM COVID19
//
...
class FSafeActionViewController: UIViewController {
    ...
    let descriptionTextView: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string: "Stay home !", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 20)])
        
        attributedText.append(NSAttributedString(string: "\n\n\nStay home when you are sick, except to get medical care.", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.gray]))
       ...
       private let nextButton: UIButton = {
           ...
           button.titleLabel?.font = UIFont.boldSystemFont(ofSize: 14)
           button.setTitleColor(.SafemainPink, for: .normal)
           button.addTarget(self, action: #selector(GSafe), for: .touchUpInside)
           return button
       }()
    ...
    fileprivate func setupBottomControls() {
     ...
     //MARK: - Selectors
    @objc func GSafe() {
        let G = GSafeActionViewController()
